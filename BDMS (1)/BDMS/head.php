...
<body>
  <div class="header">
    <a href="home.php" class="logo"<?php if($active=='home') echo "class='logo2'"; ?>>Blood & Plasma Donation </a>
    <div class="header-right">
    <a href="home.php"  <?php if($active=='about') echo "class='act'"; ?> >Home</a>
    <a href="camp_details.php"  <?php if($active=='camp') echo "class='act'"; ?>>Camp Details</a>
