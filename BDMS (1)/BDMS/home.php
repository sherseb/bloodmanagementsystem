  ...
  <div id="demo" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="image\blood_donationcover.jpeg" alt="blood_donationcover.jpeg" width="100%" height="500">
      </div>
...
<br>
        <h1 style="text-align:center;font-size:45px;">Welcome to Blood & Plasma Donation </h1>
<br>
        <div class="row">
                ...
                <div class="card">
                    <h4 class="card-header card bg-info text-white" >The need for blood</h4>
                        ...
                        <p class="card-body overflow-auto" style="padding-left:2%;height:120px;text-align:left;">
                          <?php
                            include 'conn.php';
                            $sql=$sql= "select * from pages where page_type='needblood'";
...
<br>
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <img class="img-fluid rounded" src="image\facts.jpg" alt="Card image" style="width:100%;height:300px" >
            </div>
        </div>
        <!-- /.row -->
