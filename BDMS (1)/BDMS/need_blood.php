...
<form method="POST">
<div><textarea class="form-control" name="address" placeholder="Eg. Andheri"></textarea></div></div>
</div>
...
<?php if(isset($_POST['search'])){
  ...
  $bg=$_POST['blood'];
  $sql= "select * from donor_details join blood where donor_details.donor_blood=blood.blood_id AND donor_blood='{$bg}'AND donor_details.donor_address='{$address}' order by rand() limit 5";
  $result=mysqli_query($conn,$sql) or die("query unsuccessful.");
      ...
      <div class="card" style="width:300px">
          ...
          <div class="card-body">
            ...
            <p class="card-text">
              ...
              <b>Address : </b> <?php echo $row['donor_address']; ?><br><br>
            </p>
